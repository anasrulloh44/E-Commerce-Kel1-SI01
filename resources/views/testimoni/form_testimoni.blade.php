  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
        <form class="forms-sample" action="{{ url('admin/testimoni/store') }}" method="POST">
            @csrf
          ...
          <div class="form-group row">
              ...
              <div class="col-sm-8">
                  <input type="text" class="form-control" id="produk_id" name="produk_id"
                      placeholder="Masukkan Produk ID">
              </div>
          </div>
          <div class="form-group row">
              <label for="kategoritokoh_id" class="col-sm-4 col-form-label">Kategori Tokoh ID</label>
              <div class="col-sm-8">
                  <input type="text" class="form-control" id="kategoritokoh_id" name="kategori_tokoh_id"
